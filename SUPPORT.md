...
Net Lattice has landed Stage 0.8 of its [architecture](ARCHITECTURE.md)'s Incremental Delivery Plan (route, interface, DNS-read, neighbor-read, address-read, and monitoring providers for Linux, Windows, and BSD/macOS). Usage support is limited to that surface for now — see [README.md](README.md)'s Current Status — but questions about usage, direction, and design are all welcome.
