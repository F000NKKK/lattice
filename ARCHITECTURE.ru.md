...
| 0.17 | Изменение соседей, паритет IPv6 для DNS и изолированная кроссплатформенная topology-приёмка для деструктивных операций маршрутов/адресов/соседей и facade-потоков. Детальное планирование будет в `.ai/0.17/plan.md`. |
