...
Stage 0.1 of the [architecture](ARCHITECTURE.md)'s Incremental Delivery Plan has landed:
...
This is the smallest end-to-end vertical slice — listing, adding, and removing IPv4/IPv6 routes on Linux — not a complete library. Interfaces, DNS, neighbors, other platforms, and every other item in the Long-Term Goals above are still ahead; see [ARCHITECTURE.md](ARCHITECTURE.md)'s Incremental Delivery Plan for the staged roadmap and [CHANGELOG.md](CHANGELOG.md) for what has actually shipped.
