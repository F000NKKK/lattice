...
> **Статус:** В репозитории реализованы этапы плана архитектуры вплоть до 0.4 включительно. На текущий момент присутствует несколько крейтов с реальной реализацией для просмотра, добавления и удаления маршрутов IPv4/IPv6, а также просмотра сетевых интерфейсов, в Linux, Windows и BSD/macOS. Это минимальный законченный вертикальный срез, а не полноценная библиотека — см. раздел «Текущий статус» ниже.
