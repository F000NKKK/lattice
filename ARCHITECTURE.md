...
| 0.17 | Neighbor mutation plus IPv6 DNS parity and isolated cross-platform topology acceptance for destructive route/address/neighbor and facade flows. Detailed planning is pending in `.ai/0.17/plan.md`. |
