...
- Implementation work on the next stages in [ARCHITECTURE.md](ARCHITECTURE.md)'s delivery plan (`event` module, capability-gated domains, declarative configuration, ...)
