...
- Implementation work on the next stages in [ARCHITECTURE.md](ARCHITECTURE.md)'s delivery plan (native Windows/BSD/macOS monitoring, capability-gated domains, declarative configuration, ...)
